...
execute if block ~ ~ ~ grindstone[facing=west] if data block ~-1 ~ ~ Items[0] run data remove block ~-1 ~ ~ Items[0]
...
execute if block ~ ~ ~ grindstone[facing=east] if data block ~1 ~ ~ Items[0] run data remove block ~1 ~ ~ Items[0]
tag @e[tag=new_unloaded_item] remove new_unloaded_item
...
execute if block ~ ~ ~ grindstone[facing=south] if data block ~ ~ ~1 Items[0] run data remove block ~ ~ ~1 Items[0]
tag @e[tag=new_unloaded_item] remove new_unloaded_item
...
execute if block ~ ~ ~ grindstone[facing=north] if data block ~ ~ ~-1 Items[0] run data remove block ~ ~ ~-1 Items[0]
tag @e[tag=new_unloaded_item] remove new_unloaded_item